...
- (BDPopupController *)popupController {
    if (!_popupController) {
        ...
        labelFirst.textColor = KColorFromRGB(0x171D24);
        ...
        labelSecond.textColor = KColorFromRGB(0x91979E);
        ...
        [btnFirst setBackgroundColor:KColorFromRGB(0xD9DFE6)];
        ...
        [btnFirst setTitleColor:KColorFromRGB(0x171D24) forState:UIControlStateNormal];
        ...
        [btnSecond setBackgroundColor:KColorFromRGB(0x0080FF)];
        ...
        [btnSecond setTitleColor:KColorFromRGB(0xffffff) forState:UIControlStateNormal];
