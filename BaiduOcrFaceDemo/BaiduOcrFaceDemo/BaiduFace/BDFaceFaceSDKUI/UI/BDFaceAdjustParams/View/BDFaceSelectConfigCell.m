...
float const BDFaceSelectConfigCellHeight = 60.0f;
...
- (void)layoutSubviews {
    ...
    self.bgView.frame = CGRectMake(0, 4, self.contentView.frame.size.width, BDFaceSelectConfigCellHeight-8);
    [self.bgView yz_setRoundedWithCorners:UIRectCornerAllCorners cornerRadious:8];
