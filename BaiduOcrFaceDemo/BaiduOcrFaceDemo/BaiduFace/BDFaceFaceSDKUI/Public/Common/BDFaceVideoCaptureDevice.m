...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer fromConnection:(AVCaptureConnection *)connection {
    ...
    if ([self.delegate respondsToSelector:@selector(captureOutputSampleBuffer:image:)] && sampleImage != nil) {
        [self.delegate captureOutputSampleBuffer:sampleBuffer image:sampleImage];
    }
}
